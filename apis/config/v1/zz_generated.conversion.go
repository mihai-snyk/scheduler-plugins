...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*MultiObjectiveArgs)(nil), (*config.MultiObjectiveArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_MultiObjectiveArgs_To_config_MultiObjectiveArgs(a.(*MultiObjectiveArgs), b.(*config.MultiObjectiveArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.MultiObjectiveArgs)(nil), (*MultiObjectiveArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_MultiObjectiveArgs_To_v1_MultiObjectiveArgs(a.(*config.MultiObjectiveArgs), b.(*MultiObjectiveArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_MultiObjectiveArgs_To_config_MultiObjectiveArgs(in *MultiObjectiveArgs, out *config.MultiObjectiveArgs, s conversion.Scope) error {
	out.ObjectiveWeights = *(*[]float64)(unsafe.Pointer(&in.ObjectiveWeights))
	return nil
}

// Convert_v1_MultiObjectiveArgs_To_config_MultiObjectiveArgs is an autogenerated conversion function.
func Convert_v1_MultiObjectiveArgs_To_config_MultiObjectiveArgs(in *MultiObjectiveArgs, out *config.MultiObjectiveArgs, s conversion.Scope) error {
	return autoConvert_v1_MultiObjectiveArgs_To_config_MultiObjectiveArgs(in, out, s)
}

func autoConvert_config_MultiObjectiveArgs_To_v1_MultiObjectiveArgs(in *config.MultiObjectiveArgs, out *MultiObjectiveArgs, s conversion.Scope) error {
	out.ObjectiveWeights = *(*[]float64)(unsafe.Pointer(&in.ObjectiveWeights))
	return nil
}

// Convert_config_MultiObjectiveArgs_To_v1_MultiObjectiveArgs is an autogenerated conversion function.
func Convert_config_MultiObjectiveArgs_To_v1_MultiObjectiveArgs(in *config.MultiObjectiveArgs, out *MultiObjectiveArgs, s conversion.Scope) error {
	return autoConvert_config_MultiObjectiveArgs_To_v1_MultiObjectiveArgs(in, out, s)
}
